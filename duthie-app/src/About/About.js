...
export function About() {
    return (
        <div style={{overflowY: "scroll", height: "100%"}}>
            ...
            <div className="about">
                <Typography variant="h6" className="center margin-bottom aboutText">Welcome to Duthie Park!</Typography>
                ...
                <Typography variant="h6" className="center margin-bottom aboutText">
                    Opening times
                </Typography>
